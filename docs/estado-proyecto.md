...
# 3. Verificar migraciones aplicadas (deben ser 30)
...
- **Base de datos** (FASE 2 en adelante): 30 migraciones aplicadas. Ver `base-de-datos.md` para el detalle y el listado completo.
...
- **Sin implementar todavía:** caja, insumos/inventario/kardex, proveedores/compras, recetas (mezcla de insumos por platillo), reportes, auditoría, configuración, y el portal de clientes (login/pago).
