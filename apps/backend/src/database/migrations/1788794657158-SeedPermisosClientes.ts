...
/**
 * Agrega los permisos del modulo Clientes (FASE 11) y se los asigna
 * al rol Administrador, siguiendo el mismo patron de SeedPermisosCategorias.
 */
export class SeedPermisosClientes1788794657158 implements MigrationInterface {
  name = 'SeedPermisosClientes1788794657158';
