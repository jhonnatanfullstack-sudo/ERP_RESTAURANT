...
/**
 * Agrega los permisos del modulo Reservas (FASE 11.5) y se los asigna
 * al rol Administrador, siguiendo el mismo patron de SeedPermisosCategorias.
 */
export class SeedPermisosReservas1788796754860 implements MigrationInterface {
  name = 'SeedPermisosReservas1788796754860';

  private readonly permisos = [
    ['reservas.ver', 'Ver reservas'],
    ['reservas.crear', 'Crear reservas'],
    ['reservas.editar', 'Editar reservas'],
    ['reservas.eliminar', 'Cancelar reservas'],
  ];
