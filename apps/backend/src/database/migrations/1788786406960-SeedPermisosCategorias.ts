...
/**
 * Agrega los permisos del modulo Categorias (FASE 8) y se los asigna
 * al rol Administrador, siguiendo el mismo patron de SeedRbacInicial.
 */
export class SeedPermisosCategorias1788786406960 implements MigrationInterface {
  name = 'SeedPermisosCategorias1788786406960';
